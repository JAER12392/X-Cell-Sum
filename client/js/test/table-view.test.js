 ...
 describe('table-view', () => {
             ...
             describe('formula bar', () => {
                 it('makes changes TO value of current cell', () => {
             ...
             describe('table footer', () => {
                     it('sums of footer row of postive numbers', () => {
                             ...
                             //inspect resulting footer state
                             const footCells = document.querySelectorAll('TFOOT TD');
                             expect(footCells[1].textContent).toBe('10';)
                         }
                     });
             });
